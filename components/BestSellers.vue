  ...
  <section class="p-4 flex flex-col mt-8">
    <div class="flex flex-row justify-between lg:gap-11">
      <div class="flex flex-row">
        <solid-tag-icon class="lg:w-14 w-8 lg:h-14 h-8 text-a2blue"/>
        <h1 class="text-a2blue text-xl lg:text-5xl font-light lg:font-extralight tracking-wider">Top Selling Items</h1>
      </div>

      <nuxt-link to="/best-sellers" class="text-gray-700 font-light text-xs lg:text-xl p-2 lg:p-4">View all &#8594;</nuxt-link>
    </div>
